...
6. Cliquez sur **Autoriser** pour autoriser SOLUTION Bridge à accéder à votre point de vente enregistré sur HubRise. Si votre compte possède plusieurs points de vente, développez **Choisissez le point de vente**, sélectionnez le point de vente à connecter, puis cliquez sur **Autoriser**.
...
Pour faciliter la prise en charge de vos demandes, nous vous recommandons de donner accès à votre compte HubRise à l'éditeur de SOLUTION.
\-- OU --
Pour connecter SOLUTION, vous devez donner accès au support de SOLUTION à votre compte HubRise. Cela permettra également de faciliter la prise en charge de vos demandes de support auprès du support de SOLLUTION.
...
3. Cliquez sur l'icône **+** pour permettre au support de SOLUTION d'accéder à votre compte.
