...
Pour recevoir des commandes dans HubRise, la première étape consiste à connecter WooCommerce à HubRise. Si ce n'est pas fait, suivez les étapes dans [Connexion à HubRise](/apps/woocommerce/connexion-hubrise).

Si vous avez connecté WooCommerce à HubRise, mais que vous ne recevez pas de commandes dans HubRise, vérifiez les éléments suivants.
...
Si vous ne trouvez pas les deux entrées, vous devez reconnecter le bridge et vérifier à nouveau les crochets Web WooCommerce. Pour plus d'informations sur la connexion du bridge, voir [Connexion à HubRise](/apps/woocommerce/connexion-hubrise).
...
1. Ouvrez votre back-office WooCommerce.
2. Dans le menu du haut, cliquez sur **Voir la boutique**. Cela ouvre votre site internet WooCommerce.
...
1. Dans le back-office HubRise, cliquez sur **Données** > **Commandes**.
2. Recherchez votre commande fictive.
...
S'il n'y a pas de clé `HubRise - API`, cela signifie qu'elle a été supprimée. Vous devez alors reconnecter le bridge. Pour plus d'informations sur la reconnexion du bridge, voir [Connexion à HubRise](/apps/woocommerce/connexion-hubrise).
...
3. Sélectionnez l'option **Utiliser OAuth1**.
...
Vérifiez si cette modification a permis de résoudre les erreurs 401. Si ce n'est pas le cas, consultez les autres étapes de dépannage ou contactez le support HubRise.
