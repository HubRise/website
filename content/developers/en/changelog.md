...
| ----- | ------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 03/07 | **Integration Update**                     | Uber Eats, Deliveroo, Glovo, Delivery Hero and Just Eat (JET Connect/Flyt) now synchronise order acceptance (`normal`, `busy`, `paused`), and preparation time with HubRise (when supported by the platform).               |
